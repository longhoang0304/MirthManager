...
export interface IAuthUseCase {
  ...
  readonly register: (name: string, password: string) => Fx.Effect<void, Error>
...
const withCryptoService = (
  configLayer: Lyr.Layer<CryptoConfigService, Error>
  ...
  AuthUseCase.of({
    login: (password: string) =>
      Fx.gen(function* () {
        ...
        return result
      }).pipe(Fx.provide(withCryptoService(CryptoConfigForLogin(password)))),
